...
public class HU7NegativoUITest {
	...
	//hace click en Añadir nueva excursión, pero deja en blanco el formulario
	//a excepción del ratio, que lo pone negativo.
	//El sistema le devuelve el formulario con mensajes de error en los
	//campos obligatorios sin rellenar y en el ratio, que no debe ser negativo
	@Test
	public void testHU7NegativoUI() throws Exception {
