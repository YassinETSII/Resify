...
public class HU4NegativoUITest {
	...
	//pero no escribe justificación y el sistema le devuelve un mensaje de error indicando
	//que debe escribir una justificación y mostrándole de nuevo el formulario
	@Test
