...
public class HU8NegativoUITest {
	...
	//El usuario manager accede a la lista de excursiones y entra
	//en el show de una de ella, haciendo click en inscribirse,
	//pero como su residencia no cumple con el ratio de aceptación requerido
	//recibe un mensaje del sistema que le dice que no cumple con el ratio requerido
	//y no puede inscribirse
	@Test
	public void testHU8NegativoUI() throws Exception {
