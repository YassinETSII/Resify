...
public class HU5PositivoUITest {
	...
	//El usuario manager accede la lista de buenas acciones y
	//hace click en Añadir nueva buena acción,
	//rellenando el posterior formulario y creando la buena acción
	//correctamente
	@Test
	public void testHU5PositivoUI() throws Exception {
		...
		this.driver.findElement(By.xpath("//a[contains(@href, '/buenas-acciones')]")).click();
		this.driver.findElement(By.linkText("Añadir nueva buena accion")).click();
