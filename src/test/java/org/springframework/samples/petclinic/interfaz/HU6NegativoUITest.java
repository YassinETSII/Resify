...
public class HU6NegativoUITest {
	...
	//pero deja en blanco el formulario y el sistema le devuelve
	//errores en los campos obligatorios, impidiéndole crearla
	@Test
	public void testHU6NegativoUI() throws Exception {
