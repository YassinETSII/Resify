...
public class HU8PositivoUITest {
	...
	//en el show de una de ella, haciendo click en inscribirse y
	//rellenando correctamente el formulario, publicando su petición
	@Test
	public void testHU8PositivoUI() throws Exception {
