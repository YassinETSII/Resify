...
public class HU3PositivoUITest {
	...
	//El manager decide aceptar la inscripción, guardando el resultado
	//y siendo redirigido a la vista de inscripciones
	@Test
	public void testHU3PositivoUI() throws Exception {
